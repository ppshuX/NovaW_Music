...
**详细使用指南请查看：**[`docs/USER_MANUAL.md`](docs/USER_MANUAL.md)
...
- 📖 **[完整使用手册](docs/USER_MANUAL.md)** - 详细的功能使用指南
- 🚀 **[快速开始](QUICKSTART.md)** - 5分钟快速上手
- ⚙️ **[设置指南](docs/SETUP_GUIDE.md)** - 云开发配置说明
- ☁️ **[云开发迁移](docs/CLOUD_MIGRATION.md)** - 从本地存储迁移到云开发
- 🗄️ **[数据库设计](docs/DATABASE_DESIGN.md)** - 数据结构说明
- 📥 **[数据导入](docs/IMPORT_GUIDE.md)** - 批量导入历史歌曲
